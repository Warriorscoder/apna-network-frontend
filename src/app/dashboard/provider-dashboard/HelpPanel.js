...
import { HelpCircle, Mail, MessageCircle, Briefcase, Phone } from "lucide-react";
...
export default function HelpPanel() {
  ...
  const [formData, setFormData] = useState({
    ...
    subject: "",
    message: "",
    serviceType: "Provider Help & Support"
  });
        ...
        <div className="bg-white/70 rounded-xl shadow-lg p-4 sm:p-6 border border-white/30 backdrop-blur-sm hover:shadow-xl transition-all">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 bg-[#695aa6] hover:bg-[#5a4d8a] rounded-lg p-2.5 sm:p-3 text-white font-medium transition disabled:bg-gray-400 disabled:cursor-not-allowed cursor-pointer"
            >
