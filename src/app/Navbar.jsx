  ...
  const getDashboardLink = () => {
    ...
    switch (role) {
      ...
      default:
        ...
        if (localStorage.getItem("provider")) return "/dashboard/provider-dashboard"
  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={`h-0.5 w-full bg-gradient-to-r from-[#695aa6] to-[#5a4d8a] transition-opacity duration-300 ${
            scrolled || isMobileMenuOpen ? "opacity-0" : "opacity-60"
          }`}
        ></div>
      </header>
