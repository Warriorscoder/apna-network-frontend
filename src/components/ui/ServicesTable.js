  ...
  return (
    <div className="w-full">
      ...
      <ul className="sm:hidden space-y-3">
        {services.map(s => (
          <li key={s._id} className="bg-white border rounded-lg p-4 text-xs shadow-sm">
            <div className="flex justify-between items-start">
              <h3 className="font-semibold text-[#695aa6]">{s.title}</h3>
            ...
            <div className="mt-2 space-y-1 text-gray-600">
              <p><span className="font-medium">Provider:</span> {s.provider || s.provider_name || s.provider_id?.name || 'N/A'}</p>
      ...
      {/* Desktop table */}
      <div className="overflow-x-auto hidden sm:block px-2 sm:px-4">
