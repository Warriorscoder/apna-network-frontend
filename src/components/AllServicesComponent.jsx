...
//             // --- FIX --- Added a placeholder for rating to avoid errors
//             rating: "4.5", // TODO: Replace with actual rating data from your API
//           };
//         });

//         // --- DEBUG --- 2. Check the data after you've transformed it
//         console.log("2. Transformed data to be set in state:", transformedData);
...
//   // --- DEBUG --- Add logs right before the render starts
//   console.log("3. Master provider list from state:", filteredProviders);
//   console.log("4. Final array for display:", filteredAndSearchedProviders);
//   console.log("5. Current filter values:", {
//     searchTerm,
//     selectedState,
//     selectedCity,
//     selectedTehsil,
  ...
  useEffect(() => {
    const fetchReviews = async () => {
      try {
        ...
        if (allReviews.data.success) {
          console.log("all reviews data fetched", allReviews.data.data);
          setAllReviews(allReviews.data.data);
        }
